...
void ABoard::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    PlayerInputComponent->BindAction("RotarDeFrente", IE_Pressed, this, &ABoard::RotarDeFrente);
    PlayerInputComponent->BindAction("RotarDeEspalda", IE_Pressed, this, &ABoard::RotarDeEspalda);
...
void ABoard::RotarDeFrente() {
    UE_LOG(LogTemp, Warning, TEXT("Rotar de Frente"));
    if (CurrentPiece && Status != PS_GOT_BOTTOM)
    {
        CurrentPiece->RotarFrente();
    }
}
void ABoard::RotarDeEspalda() {
    UE_LOG(LogTemp, Warning, TEXT("Rotar de Espalda"));
    if (CurrentPiece && Status != PS_GOT_BOTTOM)
    {
        CurrentPiece->RotarEspalda();
    }
}
